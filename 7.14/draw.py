...
class draw:
    ...
    def draw(self,path):
        ...
        for index in map_a:
            ...
            plt.subplot(221)
            n, bins, patches = plt.hist(names.get(index)[0],bins=60,range=(0.004,0.012))
            plt.subplot(222)
            n, bins, patches = plt.hist(names.get(index)[1],bins=60,range=(0.004,0.012))
            plt.subplot(223)
            n, bins, patches = plt.hist(names.get(index)[2],bins=60,range=(0.004,0.012))
            plt.subplot(224)
            n, bins, patches = plt.hist(names.get(index)[3],bins=60,range=(0.004,0.012))
