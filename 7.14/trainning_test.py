...
处理数据
'''
data_testx_lin = (data_q1+data_q2-data_q3-data_q4)/(data_q1+data_q2+data_q3+data_q4)
data_testy_lin = (data_q1+data_q3-data_q2-data_q4)/(data_q1+data_q2+data_q3+data_q4)
