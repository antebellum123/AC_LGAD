...
数据操作
'''
data_trainy_lin = (data_q1+data_q2-data_q3-data_q4)/(data_q1+data_q2+data_q3+data_q4)
data_trainx_lin = (data_q1+data_q3-data_q2-data_q4)/(data_q1+data_q2+data_q3+data_q4)
...
#MLP
MLP = MLPRegressor(hidden_layer_sizes=(200,100),  activation='relu', solver='adam', alpha=0.0001, batch_size='auto',
